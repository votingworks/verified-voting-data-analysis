...
def export_anomalies_for_year(year):
    ...
    condensed_file = SCRIPT_DIR / f'../../data/processed/jurisdictions/{year}_verifier-jurisdictions-condensed.csv'
    machines_file = SCRIPT_DIR / f'../../data/extracted/{year}_verifier-machines.csv'
