...
def load_jurisdictions(year):
    ...
    file_path = Path(f'data/extracted/{year}_verifier-jurisdictions.csv')
...
def load_machines(year):
    ...
    file_path = Path(f'data/extracted/{year}_verifier-machines.csv')
...
def write_compressed_output(jurisdictions, year):
    ...
    output_path = Path(f'data/processed/jurisdictions/{year}_verifier-jurisdictions-condensed.csv')
