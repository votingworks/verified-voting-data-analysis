...
Reads downloaded HTML from data/downloads/eac_funding_levels.html
and extracts funding information by state, year, and grant type.

Generates: data/hava_funding.csv
"""
...
HTML_FILE = DOWNLOADS_DIR / 'eac_funding_levels.html'
OUTPUT_FILE = DATA_DIR / 'hava_funding.csv'
